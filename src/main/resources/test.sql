/*用户图像表*/
CREATE TABLE CW_GE_USER_PICTURE (
ID VARCHAR(64) NOT NULL COMMENT '主键',
USER_ID VARCHAR(64) NOT NULL COMMENT '用户ID',
PICTURE_NAME VARCHAR(100) NOT NULL DEFAULT '' COMMENT '照片路径',
FEATURE VARCHAR(1500) NULL DEFAULT NULL COMMENT '特征值',
MD5 VARCHAR(50) NULL DEFAULT NULL COMMENT '照片MD5',
FACE_ID VARCHAR(64) NULL DEFAULT NULL COMMENT '人脸库id',
ADD_TIME DATETIME NULL DEFAULT NULL COMMENT '添加时间',
PICTURE_INDEX INT(11) NULL DEFAULT NULL COMMENT '图片序号',
PRIMARY KEY (ID),
UNIQUE INDEX UNIQUE_USER_ID_PICTURE_NAME (USER_ID, PICTURE_NAME)
)
COMMENT='用户图像表'
